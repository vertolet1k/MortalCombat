 ...
 * Графический интерфейс для взаимодействия с игрой, включая боевую систему, инвентарь и таблицу рекордов.
 * 
 * @author vika
 * @version 1.0
 */
public class GUI extends javax.swing.JFrame {
     ...
     * Создает нового игрока с указанным именем и запускает первую локацию.
     */
     ...
     * Включает обновление прогрес баров здоровья и текстовых полей.
     */
